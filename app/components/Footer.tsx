      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-4 mt-1">
            ...
            {/* Email */}
            <a 
              href="mailto:ceo@naveedrehman.com" 
              className="flex items-center gap-3 text-gray-600 hover:text-[#D4AF37] transition-colors font-bold group"
            >
              ...
              <span>ceo@naveedrehman.com</span>
            </a>
